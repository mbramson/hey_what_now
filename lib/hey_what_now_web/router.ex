defmodule HeyWhatNowWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {HeyWhatNowWeb.LayoutView, :root}
  ...
  scope "/", HeyWhatNowWeb do
    ...
    live "/spaces/:id/update_name", SpaceLive.Show, :update_name
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: HeyWhatNowWeb.Telemetry
    end
  end
